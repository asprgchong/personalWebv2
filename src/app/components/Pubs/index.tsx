...
type SimpleComponentProps = {title: string, journal: string, stack: string[], description: string, github: string, paper: string, platform: string}
const SimpleComponent = ({title, journal, stack, description, github, paper, platform}: SimpleComponentProps) => {
    return(
        <div className="card_pub relative h-50 ml-5 mr-5 w-5/6 mb-5 justify-items-start p-4">
            ...
            <div className='items-center mt-5'>
                ...
                {   paper != "" ? 
                    <>
                        <a href={paper}>Read our paper on Arxiv here!</a><br/>
                    </> : <></>
                }
                {   platform != "" ? 
                    <>
                        <a href={platform}>Visit the platform here!</a>
                    </> : <></>
                }
            </div>
        </div>
